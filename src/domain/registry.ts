...
export interface EffectiveRegistry {
  ...
  /** Topology exports from vendored topology/mixed packages (module/service/model/context names). */
  readonly structuralExports: ReadonlyMap<string, { readonly kind: string; readonly source: string }>;
}
